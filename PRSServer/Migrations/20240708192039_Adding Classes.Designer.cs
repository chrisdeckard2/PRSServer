...
namespace PRSServer.Migrations
{
    ...
    [Migration("20240708192039_Adding Classes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRSServer.Models.Product", b =>
                {
                    ...
                    b.HasIndex(new[] { "PartNbr" }, "Unique_PartNbr")
                        .IsUnique();
            ...
            modelBuilder.Entity("PRSServer.Models.Request", b =>
                {
                    b.HasOne("PRSServer.Models.User", "Users")
                        .WithMany()
            ...
            modelBuilder.Entity("PRSServer.Models.RequestLine", b =>
                {
                    b.HasOne("PRSServer.Models.Product", "Products")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PRSServer.Models.Request", "Requests")
                        .WithMany()
